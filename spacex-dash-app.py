...
def get_pie_chart(site_dropdown):
    ...
    if site_dropdown == 'ALL':
        fig = px.pie(data_frame = spacex_df, values='class', names='Launch Site', title='Launches for ALL Sites')
        return fig
    else:
        specific_df=spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        fig = px.pie(data_frame = specific_df, values='class', names='Launch Site', title='Launches for Specific Sites')
        return fig
